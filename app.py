...
def validLogin(account, password):
    if account == "patient1" and password == "patient1":
        return True
    elif account == "patient2" and password == "patient2":
        return True 
    elif account == "patient3" and password == "patient3":
        return True
    elif account == "patient4" and password == "patient4":
        return True
    elif account == "patient5" and password == "patient5": 
        return True
    elif account == "patient6" and password == "patient6":
        return True
    elif account == "patient7" and password == "patient7":
        return True
    elif account == "patient8" and password == "patient8":
        return True
    elif account == "patient9" and password == "patient9":
        return True
    elif account == "patient10" and password == "patient10":
        return True
    elif account == "patient11" and password == "patient11":
        return True
    elif account == "patient12" and password == "patient12":
        return True
    elif account == "patient13" and password == "patient13":
        return True
    elif account == "patient14" and password == "patient14":
        return True
    elif account == "patient15" and password == "patient15":
        return True
    elif account == "123" and password == "123":
        return True
    else:
        return False
...
def login():
    if request.method == "GET":
        ...
        if success:
            ...
            return redirect(url_for("chatbot", tts = session["user"]["tts"]),code=307) 
        else:
            return render_template('login.html')
...
def chatbot():
    return render_template('index.html', tts = session["user"]["tts"])
...
def upload_data():
    ...
    userInfo = {"account":session["user"]["account"],"date":datetime.now().strftime("%Y-%m-%d %H:%M:%S")}
    data['message_list'].append(userInfo)
...
if __name__ == '__main__':
    ...
    # app.run(vim host='0.0.0.0', port='8888', debug=True, ssl_context=('./server.cert', 'server.key'))
